...
namespace cs350
{
	...
	private:
		...
		int			partition_objects		(std::vector<glm::vec3>* objects, int num_obj, const cs350::aabb& aabb);
		...
		void		 find_nodes_to_merge	(cs350::BVH_node_ptr* nodes, const int num_objs, int& i, int& j);
		...
		float		 compute_surface_area	(const cs350::aabb& object1, const cs350::aabb& object2);
		cs350::aabb  compute_bounding_volume(const cs350::aabb& object1, const cs350::aabb& object2);
