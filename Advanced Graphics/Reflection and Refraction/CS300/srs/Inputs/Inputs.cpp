...
void InputsManager::GeneralInputs(GameObject * MainGameObj)
{
	...
	if (mEvent.key.keysym.scancode == SDL_SCANCODE_T)
	{
		if (MainGameObj->mMod.Reflection)
		{
			MainGameObj->mMod.Reflection = !MainGameObj->mMod.Reflection;
			MainGameObj->mMod.Refraction = !MainGameObj->mMod.Refraction;
		}
		else if (MainGameObj->mMod.Refraction)
		{
			MainGameObj->mMod.Refraction = !MainGameObj->mMod.Refraction;
		}
		else if (!MainGameObj->mMod.Reflection && !MainGameObj->mMod.Refraction)
		{
			MainGameObj->mMod.Reflection = !MainGameObj->mMod.Reflection;
		}
	}
