...
Light::Light() : mAngle(0.0f), mRadius(27.0f), mStop(false), mType(SpotLight)
{
	...
	mLightSadher = GLSLProgram::CreateShaderProgram("data/Shaders/lightsvertex.vs", "data/Shaders/lightsfragment.fs");
}
