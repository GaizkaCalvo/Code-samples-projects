...
void MyWindow::Display()
{
	...
	for (size_t i = 0; i < size; i++)
	{
		...
		{
			//to use average or normals in the light
			Shader->SetUniform("mAverage", ObjgMng->mGameObjects[i]->mMod.mShowAverageNormal);
			//for the specular
...
void MyWindow::Initialize()
{
	...
	mNormalShaderProgram = GLSLProgram::CreateShaderProgram("srs/Shaders/lightsvertex.vs", "srs/Shaders/lightsfragment.fs");
