...
namespace cs350 {
    ...
    class demo_octree
    {
      private:
        ...
        void check_collisions_octree(octree<physics_object>::node* node);
        void get_all_childs(octree<physics_object>::node* node, std::vector<octree<physics_object>::node*>& childs);
